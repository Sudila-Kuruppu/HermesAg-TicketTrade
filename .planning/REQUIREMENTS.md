...
- [ ] **ADM-07**: Admin re-auth for sensitive actions: require password confirmation within 300s sliding window; cached server-side in `admin_reauth` table keyed by `(user_id, session_id)`; re-auth rate-limited 5/min/IP
